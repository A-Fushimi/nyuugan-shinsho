...
const DRUGS = [
  ...
  {id:1,name:"パルボシクリブ（イブランス）",generic:"palbociclib",co:"Pfizer",cls:"CDK4/6阻害薬",tgt:"CDK4/6",sub:["HR+/HER2-"],
   ...
   us:{s:"ok",t:"承認済 2015/2",url:"https://www.accessdata.fda.gov/scripts/cder/daf/index.cfm?event=overview.process&ApplNo=207103"},eu:{s:"ok",t:"承認済 2016/11",url:"https://www.ema.europa.eu/en/medicines/human/EPAR/ibrance"},jp:{s:"ok",t:"承認済 2017/9 イブランス",url:"https://www.kegg.jp/medicus-bin/japic_med?japic_code=00068468"},
  ...
  {id:3,name:"アベマシクリブ（ベージニオ）",generic:"abemaciclib",co:"Eli Lilly",cls:"CDK4/6阻害薬",tgt:"CDK4/6",sub:["HR+/HER2-"],
   ...
   us:{s:"ok",t:"承認済 2017/9",url:"https://www.accessdata.fda.gov/scripts/cder/daf/index.cfm?event=overview.process&ApplNo=208855"},eu:{s:"ok",t:"承認済 2018/10",url:"https://www.ema.europa.eu/en/medicines/human/EPAR/verzenios"},jp:{s:"ok",t:"承認済 2018/11 ベージニオ",url:"https://www.kegg.jp/medicus-bin/japic_med?japic_code=00067766"},
  ...
  {id:4,name:"イムルネストラント（イムルリオ）",generic:"imlunestrant",co:"Eli Lilly",cls:"経口SERD",tgt:"ER",sub:["HR+/HER2-"],
   ...
   us:{s:"ok",t:"承認済 2025/9 Inluriyo",url:"https://www.accessdata.fda.gov/scripts/cder/daf/index.cfm?event=overview.process&ApplNo=219060"},eu:{s:"ok",t:"承認済 2026/1",url:"https://www.ema.europa.eu/en/medicines/human/EPAR/inluriyo"},jp:{s:"ok",t:"承認済 2025/12/22 イムルリオ",url:"https://www.kegg.jp/medicus-bin/japic_med?japic_code=00071900"},
  ...
  {id:11,name:"カピバセルチブ（トルカプ）",generic:"capivasertib",co:"AstraZeneca",cls:"AKT阻害薬",tgt:"AKT",sub:["HR+/HER2-"],
   ...
   us:{s:"ok",t:"承認済 2023/11 Truqap",url:"https://www.accessdata.fda.gov/scripts/cder/daf/index.cfm?event=overview.process&ApplNo=218197"},eu:{s:"ok",t:"承認済 2024/4",url:"https://www.ema.europa.eu/en/medicines/human/EPAR/truqap"},jp:{s:"ok",t:"承認済 2024/9 トルカプ",url:"https://www.kegg.jp/medicus-bin/japic_med?japic_code=00071364"},
  ...
  {id:12,name:"エベロリムス（アフィニトール）",generic:"everolimus",co:"Novartis",cls:"mTOR阻害薬",tgt:"mTOR",sub:["HR+/HER2-"],
   ...
   us:{s:"ok",t:"承認済 2012/7",url:"https://www.accessdata.fda.gov/scripts/cder/daf/index.cfm?event=overview.process&ApplNo=022334"},eu:{s:"ok",t:"承認済 2012/8",url:"https://www.ema.europa.eu/en/medicines/human/EPAR/afinitor"},jp:{s:"ok",t:"承認済 2014/3 アフィニトール",url:"https://www.kegg.jp/medicus-bin/japic_med?japic_code=00060719"},
  ...
  {id:21,name:"T-DM1 カドサイラ",generic:"trastuzumab emtansine",co:"Roche",cls:"ADC（HER2）",tgt:"HER2",sub:["HER2+"],
   ...
   us:{s:"ok",t:"承認済 2013/2",url:"https://www.accessdata.fda.gov/scripts/cder/daf/index.cfm?event=overview.process&ApplNo=125427"},eu:{s:"ok",t:"承認済 2013/11",url:"https://www.ema.europa.eu/en/medicines/human/EPAR/kadcyla"},jp:{s:"ok",t:"承認済 2013/9 カドサイラ",url:"https://www.kegg.jp/medicus-bin/japic_med?japic_code=00062677"},
  ...
  {id:23,name:"フェスゴ（HP皮下注）",generic:"pertuzumab+trastuzumab SC",co:"Roche",cls:"抗HER2抗体皮下注",tgt:"HER2",sub:["HER2+"],
   ...
   us:{s:"ok",t:"承認済 2020/6 Phesgo",url:"https://www.accessdata.fda.gov/scripts/cder/daf/index.cfm?event=overview.process&ApplNo=761170"},eu:{s:"ok",t:"承認済 2020/12",url:"https://www.ema.europa.eu/en/medicines/human/EPAR/phesgo"},jp:{s:"ok",t:"承認済 2023/9 フェスゴ",url:"https://www.kegg.jp/medicus-bin/japic_med?japic_code=00071051"},
  ...
  {id:26,name:"ラパチニブ（タイケルブ）",generic:"lapatinib",co:"Novartis(GSK)",cls:"HER2 TKI",tgt:"HER1/HER2",sub:["HER2+"],
   ...
   us:{s:"ok",t:"承認済 2007/3 Tykerb"},eu:{s:"ok",t:"承認済 2008/6"},jp:{s:"ok",t:"承認済 2009/4 タイケルブ",url:"https://www.kegg.jp/medicus-bin/japic_med?japic_code=00056915"},
  ...
  {id:30,name:"ペムブロリズマブ（キイトルーダ）",generic:"pembrolizumab",co:"Merck/MSD",cls:"免疫CPI（PD-1）",tgt:"PD-1",sub:["TNBC"],
   ...
   us:{s:"ok",t:"承認済（TNBC EBC+MBC）"},eu:{s:"ok",t:"承認済"},jp:{s:"ok",t:"承認済 キイトルーダ",url:"https://www.kegg.jp/medicus-bin/japic_med?japic_code=00068708"},
  ...
  {id:31,name:"トロデルビ（Sac-Gov）",generic:"sacituzumab govitecan",co:"Gilead",cls:"ADC（TROP2）",tgt:"TROP2",sub:["TNBC","HR+/HER2-"],
   ...
   us:{s:"ok",t:"承認済 2020/4 Trodelvy（TNBC+HR+）",url:"https://www.accessdata.fda.gov/scripts/cder/daf/index.cfm?event=overview.process&ApplNo=761115"},eu:{s:"ok",t:"承認済",url:"https://www.ema.europa.eu/en/medicines/human/EPAR/trodelvy"},jp:{s:"ok",t:"承認済 2024/3 トロデルビ（TNBC）",url:"https://www.kegg.jp/medicus-bin/japic_med?japic_code=00071544"},
  ...
  {id:33,name:"オラパリブ（リムパーザ）",generic:"olaparib",co:"AstraZeneca",cls:"PARP阻害薬",tgt:"PARP",sub:["TNBC","HR+/HER2-"],
   ...
   us:{s:"ok",t:"承認済 2018/1（gBRCA MBC）2022/3（EBC）",url:"https://www.accessdata.fda.gov/scripts/cder/daf/index.cfm?event=overview.process&ApplNo=206995"},eu:{s:"ok",t:"承認済",url:"https://www.ema.europa.eu/en/medicines/human/EPAR/lynparza"},jp:{s:"ok",t:"承認済 リムパーザ",url:"https://www.kegg.jp/medicus-bin/japic_med?japic_code=00067280"},
  ...
  {id:34,name:"タラゾパリブ（ターゼナ）",generic:"talazoparib",co:"Pfizer",cls:"PARP阻害薬",tgt:"PARP",sub:["TNBC","HR+/HER2-"],
   ...
   us:{s:"ok",t:"承認済 2018/10 Talzenna",url:"https://www.accessdata.fda.gov/scripts/cder/daf/index.cfm?event=overview.process&ApplNo=211651"},eu:{s:"ok",t:"承認済",url:"https://www.ema.europa.eu/en/medicines/human/EPAR/talzenna"},jp:{s:"ok",t:"承認済 ターゼナ",url:"https://www.kegg.jp/medicus-bin/japic_med?japic_code=00071223"},
