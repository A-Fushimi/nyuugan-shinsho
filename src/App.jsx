...
const LANDSCAPE = [
  // --- ADC ---
  {id:"ARX788",name:"ARX788",co:"Ambrx/J&J",moa_cat:"ADC",tgt:"HER2",sub:["HER2+"],stage:"PhII",nct:"NCT05041972",nct_url:"https://clinicaltrials.gov/study/NCT05041972",status:"active",fih_date:"2018-06",n_enrolled:268,early_result:"ORR 56% (HER2+ MBC 2L+)",source_url:"https://doi.org/10.1200/JCO.2023.41.16_suppl.1023",source_label:"ASCO 2023 poster",note:"site-specific conjugation ADC",updated:"2026-03-22"},
  {id:"RC48",name:"RC48 (disitamab vedotin)",co:"RemeGen",moa_cat:"ADC",tgt:"HER2",sub:["HER2+","HER2-low"],stage:"PhII",nct:"NCT04400695",nct_url:"https://clinicaltrials.gov/study/NCT04400695",status:"active",fih_date:"2017-03",n_enrolled:null,early_result:"ORR 42.9% (HER2-low BC)",source_url:"https://doi.org/10.1038/s41591-024-02884-2",source_label:"Nat Med 2024",note:"中国承認済 (胃癌/UC)。乳癌はPhII",updated:"2026-03-22"},
  {id:"MRG002",name:"MRG002",co:"Shanghai Miracogen (LeadArt Bio)",moa_cat:"ADC",tgt:"HER2",sub:["HER2+"],stage:"PhII",nct:"NCT04924699",nct_url:"https://clinicaltrials.gov/study/NCT04924699",status:"recruiting",fih_date:"2020-01",n_enrolled:null,early_result:"ORR 50% (HER2+ MBC)",source_url:"https://doi.org/10.1200/JCO.2022.40.16_suppl.1039",source_label:"ASCO 2022",note:"MMAE payload ADC",updated:"2026-03-22"},
  // --- ADC (新規標的) ---
  {id:"AZD8205",name:"AZD8205",co:"AstraZeneca",moa_cat:"ADC_novel_target",tgt:"B7-H4",sub:["HR+/HER2-","TNBC"],stage:"PhI",nct:"NCT05123482",nct_url:"https://clinicaltrials.gov/study/NCT05123482",status:"recruiting",fih_date:"2022-01",n_enrolled:null,early_result:"初期データ待ち",source_url:"https://www.astrazeneca.com/our-therapy-areas/oncology/pipeline.html",source_label:"AZ pipeline",note:"B7-H4は乳癌で高発現の新規標的",updated:"2026-03-22"},
  {id:"SGN-B7H4V",name:"SGN-B7H4V",co:"Pfizer (Seagen)",moa_cat:"ADC_novel_target",tgt:"B7-H4",sub:["HR+/HER2-","TNBC"],stage:"PhI",nct:"NCT05194072",nct_url:"https://clinicaltrials.gov/study/NCT05194072",status:"recruiting",fih_date:"2022-06",n_enrolled:null,early_result:"ORR 40%+ (dose escalation)",source_url:"https://doi.org/10.1200/JCO.2024.42.16_suppl.1025",source_label:"ASCO 2024",note:"vcMMAE payload",updated:"2026-03-22"},
  {id:"STRO-002",name:"STRO-002 (luvelta)",co:"Sutro Biopharma",moa_cat:"ADC_novel_target",tgt:"FRα",sub:["TNBC"],stage:"PhI",nct:"NCT05174786",nct_url:"https://clinicaltrials.gov/study/NCT05174786",status:"recruiting",fih_date:"2022-03",n_enrolled:null,early_result:"初期安全性確認",source_url:"https://www.sutrobio.com/pipeline/",source_label:"Sutro pipeline",note:"FRα標的。卵巣癌先行",updated:"2026-03-22"},
  // --- Bispecific ---
  {id:"zanidatamab",name:"zanidatamab",co:"Zymeworks/Jazz",moa_cat:"bispecific",tgt:"HER2 biparatopic",sub:["HER2+"],stage:"PhII",nct:"NCT04276493",nct_url:"https://clinicaltrials.gov/study/NCT04276493",status:"active",fih_date:"2019-05",n_enrolled:null,early_result:"ORR 37% (HER2+ MBC 3L+)",source_url:"https://doi.org/10.1016/S1470-2045(23)00517-3",source_label:"Lancet Oncol 2024",note:"胆管癌承認済 (zanidatamab+chemo)。乳癌はPhII",updated:"2026-03-22"},
  {id:"KN026",name:"KN026",co:"Alphamab/Jiangsu Hengrui",moa_cat:"bispecific",tgt:"HER2 biparatopic",sub:["HER2+"],stage:"PhII",nct:"NCT04521179",nct_url:"https://clinicaltrials.gov/study/NCT04521179",status:"active",fih_date:"2019-01",n_enrolled:null,early_result:"ORR 27.2% (HER2+ MBC)",source_url:"https://doi.org/10.1200/JCO.2022.40.16_suppl.1009",source_label:"ASCO 2022",note:"中国Phase III開始",updated:"2026-03-22"},
  // --- PROTAC/degrader ---
  {id:"AC682",name:"AC682",co:"Accutar Biotech",moa_cat:"PROTAC_degrader",tgt:"ER (molecular glue)",sub:["HR+/HER2-"],stage:"PhI",nct:"NCT05489679",nct_url:"https://clinicaltrials.gov/study/NCT05489679",status:"recruiting",fih_date:"2022-09",n_enrolled:null,early_result:"Phase I dose escalation中",source_url:"https://www.accutarbio.com/pipeline/",source_label:"Accutar pipeline",note:"molecular glue型ER degrader。vepdegestrant(PROTAC)と異なるメカニズム",updated:"2026-03-22"},
  // --- 次世代CDK ---
  {id:"PF-07220060",name:"PF-07220060",co:"Pfizer",moa_cat:"CDK_next",tgt:"CDK2",sub:["HR+/HER2-"],stage:"PhIb/II",nct:"NCT05757141",nct_url:"https://clinicaltrials.gov/study/NCT05757141",status:"recruiting",fih_date:"2023-04",n_enrolled:null,early_result:"CDK4/6i耐性後の活性示唆",source_url:"https://doi.org/10.1200/JCO.2024.42.16_suppl.TPS1127",source_label:"ASCO 2024 TPS",note:"CDK4/6i耐性克服の次世代CDK2阻害薬",updated:"2026-03-22"},
  ...
  // --- 細胞治療 ---
  {id:"CT041",name:"CT041",co:"CARsgen Therapeutics",moa_cat:"cell_therapy",tgt:"CLDN18.2 CAR-T",sub:["TNBC"],stage:"PhI",nct:"NCT04404595",nct_url:"https://clinicaltrials.gov/study/NCT04404595",status:"recruiting",fih_date:"2020-06",n_enrolled:null,early_result:"胃癌でORR 57.1%。乳癌コホート進行中",source_url:"https://doi.org/10.1038/s41591-023-02465-x",source_label:"Nat Med 2023",note:"固形がんCAR-T。CLDN18.2発現乳癌サブセット",updated:"2026-03-22"},
  // --- RDC ---
  {id:"HER2-TTC",name:"[177Lu]Lu-DOTA-trastuzumab",co:"Multiple (academic)",moa_cat:"RDC",tgt:"HER2 (radioligand)",sub:["HER2+"],stage:"PhI",nct:"NCT04842812",nct_url:"https://clinicaltrials.gov/study/NCT04842812",status:"active",fih_date:"2021-08",n_enrolled:null,early_result:"dose escalation中",source_url:"https://doi.org/10.2967/jnumed.121.263025",source_label:"J Nucl Med 2022",note:"HER2標的放射性医薬品。前立腺癌RDCの成功を受け開発加速",updated:"2026-03-22"},
  // --- その他低分子 ---
  {id:"TNO155",name:"TNO155",co:"Novartis",moa_cat:"small_mol_other",tgt:"SHP2",sub:["HR+/HER2-","TNBC"],stage:"PhIb/II",nct:"NCT04330664",nct_url:"https://clinicaltrials.gov/study/NCT04330664",status:"active",fih_date:"2020-06",n_enrolled:null,early_result:"併用で安定した忍容性",source_url:"https://www.novartis.com/research-development/pipeline",source_label:"Novartis pipeline",note:"SHP2阻害薬。RAS/MAPK経路耐性メカニズムに対する新アプローチ",updated:"2026-03-22"},
  {id:"LY3537982",name:"LY3537982 (olomorasib)",co:"Eli Lilly",moa_cat:"small_mol_other",tgt:"KRAS G12C",sub:["TNBC"],stage:"PhI",nct:"NCT04956640",nct_url:"https://clinicaltrials.gov/study/NCT04956640",status:"recruiting",fih_date:"2021-08",n_enrolled:null,early_result:"NSCLC ORR 58%。乳癌KRAS G12Cは稀だがバスケット試験に含む",source_url:"https://doi.org/10.1200/JCO.2024.42.16_suppl.3009",source_label:"ASCO 2024",note:"KRAS G12C変異は乳癌で1-2%。バスケット試験で探索",updated:"2026-03-22"},
  // --- Bispecific ADC ---
...
function GanttChart(){
  ...
  return(
    <div>
      ...
      {/* Year axis */}
      <div style={{position:"relative",marginLeft:220,marginRight:8,height:24,borderBottom:"1px solid #e2e8f0",marginBottom:4}}>
